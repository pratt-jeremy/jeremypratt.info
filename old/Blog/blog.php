...
<html>
    ...
    <body>
        ...
        <div class="column1">
            <p><a href="FAQ.php" 
            title=”View the FAQ”>FAQ</a>
                </p>
                <p><a href="donate.php" 
            title=”View the Donate”>Donate</a>
                </p>
        </div>
        <div class="column2">
                <h1>Blog</h1>
                <p>This page is dedicated to any updates I want to comment on
                whether it be politics, technology, or just reviews of different 
                things I've tried.</p>
                <h3>16 June 2014</h3>
                <p>This is the beginning of all the weekly blogs I shall write.</p>
        </div>
        <div class="column3">
